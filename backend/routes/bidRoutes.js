...
const { newBid, singleProductBids, getUserBids, retractBid } = require('../controllers/bidController')
const { isAuthenticatedUser, authorizeRole } = require('../middleware/auth')

const router = express.Router()

router.route('/bid/product/new/:id').post(isAuthenticatedUser, authorizeRole('buyer'), newBid)
router.route('/bid/product/retract/:id').delete(isAuthenticatedUser, authorizeRole('buyer'), retractBid)
