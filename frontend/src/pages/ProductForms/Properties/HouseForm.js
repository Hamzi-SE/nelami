    ...
    const handleOptionsChange = (e) => {
        switch (e.target.dataset.collection) {
            ...
            case "constructionState":
                if (e.target.checked) {
                    setProductData({ ...productData, "constructionState": e.target.value })
                }
                break;
            default:
                break;
                                    ...
                                    <div className="card mb-0">
                                        ...
                                        <div className="card-body">
                                            <form method="POST" className="product-dataform product-form" encType="multipart/form-data" onSubmit={handleSubmit}>
                                                ...
                                                <div className="form-group">
                                                    <label className="form-label text-dark">Construction State</label>
                                                    <div className="available-options">
                                                        <div className="form-control">
                                                            <input type="radio" id="Grey Structure" name="constructionState" value="Grey Structure" data-collection="constructionState" onChange={handleOptionsChange} />
                                                            <label htmlFor="Grey Structure"> Grey Structure</label>
                                                        </div>
                                                        <div className="form-control">
                                                            <input type="radio" id="Finished" name="constructionState" value="Finished" data-collection="constructionState" onChange={handleOptionsChange} />
