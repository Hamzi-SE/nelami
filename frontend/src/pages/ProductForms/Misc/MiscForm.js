...
import {
    getProvinceDropList, getIslamabadSectorsDropList, getNorthernAreasCitiesDropList,
...
const MiscForm = () => {
    ...
    // const { getBidTimeDropList } = useDataFetch();
                                        ...
                                        <div className="card-body">
                                            <form method="POST" className="product-dataform product-form" encType="multipart/form-data" onSubmit={handleSubmit}>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <textarea className="form-control" maxLength="7000" name="description" onChange={handleInputChange} value={productData.description} placeholder="Enter Product Description" rows="10"></textarea>
                                                </div>
