                                        ...
                                        <div className="card-body">
                                            <form method="POST" className="product-dataform product-form" encType="multipart/form-data" onSubmit={handleSubmit}>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" className="form-control" name="model" value={productData.model} onChange={handleInputChange} placeholder="Enter Model" />
                                                </div>
                                                ...
                                                <div className="productform-images">
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <input type="file" name="imgTwo" onChange={handleInputChange} className="form-control" placeholder="Upload Photos" />
                                                    </div>
