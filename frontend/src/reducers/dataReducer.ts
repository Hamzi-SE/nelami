...
export const dataReducer = createReducer(initialState, (builder) => {
  builder
    ...
    .addCase('LOAD_DATA_SUCCESS', (state, action: any) => {
      state.loading = false
      state.data = action.payload
      state.error = null
    })
    .addCase('LOAD_DATA_FAIL', (state, action: any) => {
      state.loading = false
      state.data = null
...
export const featureReducer = createReducer(featureInitialState, (builder) => {
  builder
    ...
    .addCase('ADD_FEATURE_SUCCESS', (state, action: any) => {
      state.loading = false
      state.feature = action.payload
      state.success = true
      state.error = null
    })
    .addCase('ADD_FEATURE_FAIL', (state, action: any) => {
      state.loading = false
    ...
    .addCase('REMOVE_FEATURE_SUCCESS', (state, action: any) => {
      state.loading = false
      state.feature = action.payload
      state.success = true
      state.error = null
    })
    .addCase('REMOVE_FEATURE_FAIL', (state, action: any) => {
      state.loading = false
      state.feature = null // Ensure no stale data
      state.success = false
      state.error = action.payload
