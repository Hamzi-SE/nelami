...
export const conversationReducer = createReducer(initialState, (builder) => {
  builder
    ...
    .addCase('CREATE_CONVERSATION_SUCCESS', (state, action: any) => {
      state.conversation = action.payload
      state.loading = false
    })
    .addCase('CREATE_CONVERSATION_FAIL', (state, action: any) => {
      state.loading = false
      state.conversation = null
    ...
    .addCase('GET_CONVERSATION_SUCCESS', (state, action: any) => {
      state.conversation = action.payload
      state.loading = false
    })
    .addCase('GET_CONVERSATION_FAIL', (state, action: any) => {
      state.loading = false
      state.conversation = null
      state.error = action.payload
    })
...
export const conversationsReducer = createReducer(conversationsInitialState, (builder) => {
  builder
    ...
    .addCase('GET_ALL_CONVERSATIONS_SUCCESS', (state, action: any) => {
      state.conversations = action.payload
      state.loading = false
    })
    .addCase('GET_ALL_CONVERSATIONS_FAIL', (state, action: any) => {
      state.loading = false
      state.conversations = null
      state.error = action.payload
    })
    .addCase('UPDATE_CONVERSATION_LAST_MESSAGE', (state, action: any) => {
    ...
    .addCase('SET_USER_AVATARS', (state, action: any) => {
...
export const messagesReducer = createReducer(messagesInitialState, (builder) => {
  builder
    ...
    .addCase('GET_MESSAGES_SUCCESS', (state, action: any) => {
      state.messages = action.payload
      state.loading = false
    })
    .addCase('GET_MESSAGES_FAIL', (state, action: any) => {
      state.loading = false
      state.error = action.payload
      state.messages = []
    })
